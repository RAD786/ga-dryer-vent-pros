...
export function LeadForm({
  ...
  return (
    <form
      className="w-full min-w-0 overflow-hidden rounded-lg border border-slate-200 bg-white p-5 shadow-sm"
    ...
    >
      ...
      <div className="grid min-w-0 gap-4 sm:grid-cols-2">
        <label className="grid min-w-0 gap-2 text-sm font-bold text-slate-800">
          Name
          <input required name="name" autoComplete="name" className="block min-h-12 w-full min-w-0 rounded-md border border-slate-300 px-3 font-normal focus:border-orange-500 focus:outline-none" />
        </label>
        <label className="grid min-w-0 gap-2 text-sm font-bold text-slate-800">
          Phone
          <input required name="phone" type="tel" autoComplete="tel" className="block min-h-12 w-full min-w-0 rounded-md border border-slate-300 px-3 font-normal focus:border-orange-500 focus:outline-none" />
        </label>
        <label className="grid min-w-0 gap-2 text-sm font-bold text-slate-800">
          Email
          <input name="email" type="email" autoComplete="email" className="block min-h-12 w-full min-w-0 rounded-md border border-slate-300 px-3 font-normal focus:border-orange-500 focus:outline-none" />
        </label>
        <label className="grid min-w-0 gap-2 text-sm font-bold text-slate-800">
          City
          <input required name="city" autoComplete="address-level2" className="block min-h-12 w-full min-w-0 rounded-md border border-slate-300 px-3 font-normal focus:border-orange-500 focus:outline-none" />
        </label>
        <label className="grid min-w-0 gap-2 text-sm font-bold text-slate-800 sm:col-span-2">
          ...
          <select
            ...
            className="block min-h-12 w-full min-w-0 rounded-md border border-slate-300 px-3 font-normal focus:border-orange-500 focus:outline-none"
        ...
        {!compact ? (
          <label className="grid min-w-0 gap-2 text-sm font-bold text-slate-800 sm:col-span-2">
            Message
            <textarea name="message" rows={5} className="block w-full min-w-0 rounded-md border border-slate-300 px-3 py-3 font-normal focus:border-orange-500 focus:outline-none" />
          </label>
        ) : null}
      </div>
      <button
        type="submit"
        className="focus-ring mt-5 min-h-12 w-full rounded-md bg-orange-500 px-5 py-3 text-sm font-black !text-[#102033] transition hover:bg-orange-600"
        data-conversion-event="form_submit"
        data-city={cityPage}
