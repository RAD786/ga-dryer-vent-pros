        ...
        <div className="container grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div>
            ...
            <div className="mt-8 rounded-lg border border-slate-800 bg-slate-900 p-5">
              ...
              <PhoneLink className="focus-ring mt-3 inline-flex min-h-12 items-center gap-2 rounded-md bg-white px-4 text-base font-black !text-[#102033] hover:bg-orange-50">
                <PhoneIcon />
                <span>Call Now</span>
              </PhoneLink>
